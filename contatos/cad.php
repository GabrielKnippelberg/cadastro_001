            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    <div class="card-header py-3 text-center">
                        <h4 class="my-0 fw-normal"><b>Confirmar Convidado</b></h4>
                    </div>
                    <div class="card-body">
                        <?php
                            echo "<b>Nome: </b>".$dados['nome']."<br/>";
                            echo "<b>Acompanhate: </b>".$dados['acompanhante']."<br/>";
                            echo "<b>Itens a ser levado: </b>".$dados['itens']."<br/>";
                        ?>
                        <br/><br/>
